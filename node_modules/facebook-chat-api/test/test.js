...
var getType = require('facebook-chat-api/utils').getType;
var formatDeltaMessage = require('facebook-chat-api/utils').formatDeltaMessage;
var shareAttachmentFixture = require('facebook-chat-api/test/data/shareAttach');
